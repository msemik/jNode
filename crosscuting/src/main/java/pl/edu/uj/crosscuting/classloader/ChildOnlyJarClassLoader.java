...
import pl.edu.uj.crosscuting.classloader.ChildFirstJarClassLoader.Mode;

import java.io.*;
import java.net.URL;
import java.util.Enumeration;

import static pl.edu.uj.crosscuting.classloader.ChildFirstJarClassLoader.Mode.CHILD_ONLY;
